...
XevDevice::XevDevice(XevWindow& window) : window{window} {
  createInstance();
  setupDebugMessenger();
  createSurface();
  pickPhysicalDevice();
...
void XevDevice::createInstance() {
  ...
  appInfo.pApplicationName   = "Xenon Engine Vulkan App";
...
void XevDevice::pickPhysicalDevice() {
...
void XevDevice::populateDebugMessengerCreateInfo(
...
void XevDevice::setupDebugMessenger() {
...
bool XevDevice::checkValidationLayerSupport() {
  uint32_t layerCount;
...
void XevDevice::hasGflwRequiredInstanceExtensions() {
...
bool XevDevice::checkDeviceExtensionSupport(VkPhysicalDevice device) {
...
QueueFamilyIndices XevDevice::findQueueFamilies(VkPhysicalDevice device) {
...
SwapChainSupportDetails XevDevice::querySwapChainSupport(VkPhysicalDevice device) {
...
VkFormat XevDevice::findSupportedFormat(
...
uint32_t
XevDevice::findMemoryType(uint32_t typeFilter, VkMemoryPropertyFlags properties) {
...
VkCommandBuffer XevDevice::beginSingleTimeCommands() {
...
void XevDevice::endSingleTimeCommands(VkCommandBuffer commandBuffer) {
...
void XevDevice::copyBuffer(VkBuffer srcBuffer, VkBuffer dstBuffer, VkDeviceSize size) {
...
void XevDevice::copyBufferToImage(
...
void XevDevice::createImageWithInfo(
