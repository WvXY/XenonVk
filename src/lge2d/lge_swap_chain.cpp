...
LgeSwapChain::LgeSwapChain(
    LgeDevice& deviceRef, VkExtent2D extent, std::shared_ptr<LgeSwapChain> previous)
...
VkResult
LgeSwapChain::submitCommandBuffers(const VkCommandBuffer* buffers, uint32_t* imageIndex) {
