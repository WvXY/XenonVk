...
namespace lge {
  ...
  void LgeWindow::framebufferResizeCallback(GLFWwindow *window, int width, int height) {
    auto lgeWindow = reinterpret_cast<LgeWindow *>(glfwGetWindowUserPointer(window));
