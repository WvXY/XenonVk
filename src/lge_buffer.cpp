...
*/
VkDeviceSize LgeBuffer::getAlignment(VkDeviceSize instanceSize, VkDeviceSize minOffsetAlignment) {
...
*
*/
VkResult LgeBuffer::flushIndex(int index) { return flush(alignmentSize, index * alignmentSize); }
