...
void LgePipeline::createShaderModule(
  ...
  if (vkCreateShaderModule(lgeDevice.device(), &createInfo, nullptr, shaderModule) !=
      VK_SUCCESS) {
...
void LgePipeline::defaultPipelineConfigInfo(PipelineConfigInfo& configInfo) {
  ...
  configInfo.rasterizationInfo.polygonMode             = VK_POLYGON_MODE_FILL;  // https://registry.khronos.org/vulkan/specs/1.3-extensions/man/html/VkPolygonMode.html
...
void LgePipeline::enableAlphaBlending(PipelineConfigInfo& configInfo) {
