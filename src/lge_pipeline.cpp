...
void LgePipeline::createGraphicsPipeline(const std::string& vertex_shader_path,
                                         const std::string& fragment_shader_path,
                                         const PipelineConfigInfo& configInfo) {
    ...
    if (vkCreateGraphicsPipelines(lgeDevice.device(), VK_NULL_HANDLE, 1, &pipelineInfo, nullptr,
