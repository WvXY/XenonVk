...
XevSwapChain::XevSwapChain(XevDevice& deviceRef, VkExtent2D extent)
    : device{deviceRef}, windowExtent{extent} {
  init();
}

XevSwapChain::XevSwapChain(
    XevDevice& deviceRef, VkExtent2D extent, std::shared_ptr<XevSwapChain> previous)
...
VkResult XevSwapChain::acquireNextImage(uint32_t* imageIndex) {
  vkWaitForFences(
...
VkResult
XevSwapChain::submitCommandBuffers(const VkCommandBuffer* buffers, uint32_t* imageIndex) {
...
void XevSwapChain::createSwapChain() {
...
void XevSwapChain::createImageViews() {
...
void XevSwapChain::createRenderPass() {
...
void XevSwapChain::createFramebuffers() {
...
void XevSwapChain::createDepthResources() {
...
void XevSwapChain::createSyncObjects() {
...
VkSurfaceFormatKHR XevSwapChain::chooseSwapSurfaceFormat(
...
VkExtent2D XevSwapChain::chooseSwapExtent(const VkSurfaceCapabilitiesKHR& capabilities) {
...
VkFormat XevSwapChain::findDepthFormat() {
